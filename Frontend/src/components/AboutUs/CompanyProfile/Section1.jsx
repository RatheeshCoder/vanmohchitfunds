  ...
  return (
    <div className="py-12 bg-white">
      <div className="px-6 mx-auto max-w-7xl lg:px-8">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-center text-gray-900 lg:text-5xl md:text-4xl">
  Why Thrive with&nbsp;
  <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-700 via-blue-800 to-gray-900 text-2lg lg:text-5xl md:text-3xl">
    Vanmoh
  </span>
</h1>
          ...
          <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
            {keyFeaturesData.map((feature, index) => (
              <div className="relative pl-16" key={index}>
                <dt className="text-base sm:text-lg font-semibold leading-7 text-gray-900">
                ...
                <dd className="mt-2 text-sm sm:text-base leading-7 text-gray-600">
                  {feature.description}
                </dd>
