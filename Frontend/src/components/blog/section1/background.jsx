...
const Background = () => {
  return (
    <div className="relative  cta-h-half text-white overflow-hidden">
      ...
      <h1 className="text-3xl sm:text-4xl lg:text-4xl xl:text-5xl font-bold leading-tight mb-4">
  Maximize Chit Gains
</h1>

<p className="text-sm lg:text-lg text-gray-300 mb-8 lg:w-1/2 sm:w-full">
