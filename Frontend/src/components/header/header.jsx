...
// import companylogo from '../../asset/imgs/company-logo-img.png';
...
<div className="flex justify-center logo">
    <Link to="/">
        <img className="logo-image max-w-[280px] sm:w-[230px]" src={logo} alt="Logo" />
    </Link>
</div>
      ...
      <ul className={`nav-links  ${navActive ? "nav-active" : ""}`}>
        ...
        >
          ...
          {showAboutDropdown && (
            <ul
            className={`dropdown absolute hidden bg-white border rounded-md mt-4 p-2 cta-dropdown-option w-36 h-100  `}>
              <li>
                <Link
                  to="/about/CompanyPro"
                  onClick={() => {
        ...
        >
          ...
          {showHowItWorksDropdown && (
            <ul
              className={`dropdown absolute hidden bg-white border rounded-md mt-4 p-2 cta-dropdown-option w-48 h-100`}
            >
               <li>
                <Link
