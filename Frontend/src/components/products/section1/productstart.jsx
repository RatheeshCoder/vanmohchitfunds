...
const Background = () => {
  ...
  <div className="relative z-10 flex flex-col items-center justify-center h-full text-center">
    <h1 className="mb-2 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
      Feel financial freedom
    </h1>
    <p className="mb-4 text-base sm:text-lg md:text-xl lg:text-xl text-gray-300">
      With our Chit Fund Schemes
    </p>
  </div>
</div>


    <div className="container px-6 md:px-12" data-aos="zoom-out">
